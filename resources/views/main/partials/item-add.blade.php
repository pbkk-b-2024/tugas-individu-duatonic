                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('items.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="item_id" class="block mt-1 w-full" type="text" name="item_id" :value="old('item_id')" required autofocus />
                        ...
                        <!-- Item Category -->
                        <div class="mt-4">
                            <x-input-label for="item_category" :value="__('Item Category')" />
                            <x-text-input id="item_category" class="block mt-1 w-full" type="text" name="item_category" :value="old('item_category')" required />
                            <x-input-error :messages="$errors->get('item_category')" class="mt-2" />
                        </div>
