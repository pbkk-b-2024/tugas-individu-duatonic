<x-app-layout>
    <x-slot name="header">
       <div class="flex justify-between items-center">
            ...
            <a href="{{ route('users.add') }}" class="text-white font-bold py-2 px-4 box-border bg-gray-800 rounded border border-gray-700 p-4">
            Add New User
            </a>
        </div>
    </x-slot>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 w-full border border-gray-300">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($users as $user)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-300">{{ $user->user_id }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center border border-gray-300">
                                        <a href="{{ route('users.edit', $user->user_id) }}" class="btn btn-sm btn-warning mr-2 bg-gray-400 rounded border px-2 py-2">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
