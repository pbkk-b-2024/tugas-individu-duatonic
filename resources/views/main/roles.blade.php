<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('roles.add') }}" class="text-white font-bold py-2 px-4 box-border bg-gray-800 rounded-md border border-gray-700 p-4">
            Add New Role
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('roles.index') }}" method="GET" class="form-inline rounded-md py-4 flex items-center">
                <input type="text" name="search" class="form-control mr-2 rounded-md border-gray-300 px-4" placeholder="Search roles" value="{{ request()->get('search') }}">
                ...
                <div class="p-6 text-gray-900">
                    <table class="min-w-full divide-y divide-gray-200 w-full border border-gray-300">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @else
                                <tr>
                                    <td colspan="12" class="px-6 py-4 whitespace-nowrap border border-gray-300 text-center">No roles found.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
